...
import com.whitebirdtechnology.medicalassistant.ExpertFragment.ByCategoriesFragment.ListBySpecializationAndName.ByExpertName.FeedItemListByExpertName;
...
public class AdapterListSubCat extends ArrayAdapter{
        Activity activity;
    public AdapterListSubCat(@NonNull Activity activity, @NonNull ArrayList< FeedListBySubCatExpert > objects) {
        ...
        final FeedListBySubCatExpert feedListByExpert = (FeedListBySubCatExpert) getItem(position);
