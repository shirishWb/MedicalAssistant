...
public class ListAdapterByFavourite extends ArrayAdapter {
    Activity activity;
    public ListAdapterByFavourite(@NonNull Activity activity, @NonNull ArrayList<FeedListByFavourite> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final FeedListByFavourite feedListByExpert = (FeedListByFavourite) getItem(position);
